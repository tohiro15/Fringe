...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public bool ResolveActionAndBinding(out InputAction action, out int bindingIndex)
        {
            ...
            var bindingId = new Guid(this.m_BindingId);
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (action.bindings[bindingIndex].isPartOfComposite)
                partName = $"Привязка клавиши'{action.bindings[bindingIndex].name}'. ";
            ...
            if (m_RebindText != null)
            {
                var text = !string.IsNullOrEmpty(m_RebindOperation.expectedControlType)
                    ? $"{partName}Ждем {m_RebindOperation.expectedControlType} ввод..."
                    : $"{partName}Ждем ввода...";
        ...
        {
            if (m_RebindActionUIs == null)
                m_RebindActionUIs = new List<RebindActionUI>();
            m_RebindActionUIs.Add(this);
            if (m_RebindActionUIs.Count == 1)
        ...
        protected void OnDisable()
        {
            ...
            m_RebindActionUIs.Remove(this);
            if (m_RebindActionUIs.Count == 0)
            {
                m_RebindActionUIs = null;
                InputSystem.onActionChange -= OnActionChange;
            }
        }
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            for (var i = 0; i < m_RebindActionUIs.Count; ++i)
            {
                var component = m_RebindActionUIs[i];
        ...
        private static List<RebindActionUI> m_RebindActionUIs;
